...
function ViewPerformance({ params }) {
  ...
  const breadcrumbItems = [
    ...
    { label: `${slug}`, href: `/view-performance/${slug}` },
  ];
  ...
  const fetchPerformance = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/view-performance/${slug}`,
        {
          method: "GET",
          headers: {
  ...
  const { examName, questions, answers, timeTaken } = performance;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6 text-black">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-3xl font-bold mt-2">{scorePercentage}%</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-3xl font-bold mt-2">{formatTime(timeTaken)}</p>
            </div>
          ...
          {/* Questions Section */}
          <div className="mt-8 bg-white rounded-lg shadow-sm p-6 text-black">
