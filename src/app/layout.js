...
export const metadata = {
  ...
  description:
    "Create, conduct and evaluate secure online exams with AI proctoring and real-time analytics. Trusted by 500+ educational institutions.",
  keywords:
    "online exam platform, AI proctoring, exam software, digital assessment",
  openGraph: {
    title: "StartTest.Online - Transform Your Online Testing Process",
    description:
      "AI-powered examination platform with real-time proctoring and analytics",
    images: [
      {
