...
const WYSIWYGExplainationEditor = ({ index, question, onQuestionChange }) => {
  ...
  const editor = useEditor({
    ...
    content: typeof window !== "undefined" ? question.explanation : "", // Ensure content is loaded only on the client
    editorProps: {
      attributes: {
        class:
  ...
  useEffect(() => {
    if (editor) {
      const handleEditorChange = () => {
        onQuestionChange(index, "explanation", editor.getHTML());
      };
...
export default WYSIWYGExplainationEditor;
